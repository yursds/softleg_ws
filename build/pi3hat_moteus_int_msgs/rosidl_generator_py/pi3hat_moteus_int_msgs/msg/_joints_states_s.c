...
bool pi3hat_moteus_int_msgs__msg__joints_states__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pi3hat_moteus_int_msgs.msg._joints_states.JointsStates", full_classname_dest, 54) == 0);
  }
  pi3hat_moteus_int_msgs__msg__JointsStates * ros_message = _ros_message;
  {  // header
  ...
  {  // current
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->current.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // temperature
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->temperature.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // sec_enc_pos
    PyObject * field = PyObject_GetAttrString(_pymsg, "sec_enc_pos");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->sec_enc_pos.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'sec_enc_pos'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // sec_enc_vel
    PyObject * field = PyObject_GetAttrString(_pymsg, "sec_enc_vel");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->sec_enc_vel.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'sec_enc_vel'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of JointsStates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pi3hat_moteus_int_msgs.msg._joints_states");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointsStates");
  ...
  {  // current
    ...
    if (ros_message->current.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->current.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->current.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // temperature
    ...
    if (ros_message->temperature.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->temperature.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->temperature.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // sec_enc_pos
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "sec_enc_pos");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->sec_enc_pos.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->sec_enc_pos.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->sec_enc_pos.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // sec_enc_vel
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "sec_enc_vel");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->sec_enc_vel.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->sec_enc_vel.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->sec_enc_vel.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
