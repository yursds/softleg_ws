...
class Metaclass_JointsCommand(type):
    """Metaclass of message 'JointsCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'pi3hat_moteus_int_msgs.msg.JointsCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__joints_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__joints_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__joints_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__joints_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__joints_command
...
class JointsCommand(metaclass=Metaclass_JointsCommand):
    """Message class 'JointsCommand'."""
    ...
    _fields_and_field_types = {
        ...
        'kp_scale': 'sequence<double>',
        'kd_scale': 'sequence<double>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.kp_scale = array.array('d', kwargs.get('kp_scale', []))
        self.kd_scale = array.array('d', kwargs.get('kd_scale', []))
    ...
    def kp_scale(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'kp_scale' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'kp_scale' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._kp_scale = array.array('d', value)
    ...
    def kd_scale(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'kd_scale' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'kd_scale' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._kd_scale = array.array('d', value)
