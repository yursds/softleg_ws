...
#include "pi3hat_moteus_int_msgs/msg/detail/joints_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pi3hat_moteus_int_msgs::msg::JointsStates & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: sec_enc_pos
  {
    cdr << ros_message.sec_enc_pos;
  }
  // Member: sec_enc_vel
  {
    cdr << ros_message.sec_enc_vel;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pi3hat_moteus_int_msgs::msg::JointsStates & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: sec_enc_pos
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.sec_enc_pos[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: sec_enc_vel
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.sec_enc_vel[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pi3hat_moteus_int_msgs
max_serialized_size_JointsStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pi3hat_moteus_int_msgs::msg::JointsStates;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pi3hat_moteus_int_msgs::msg::JointsStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pi3hat_moteus_int_msgs::msg::JointsStates *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JointsStates__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pi3hat_moteus_int_msgs::msg::JointsStates *>(
...
static size_t _JointsStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointsStates(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JointsStates__callbacks = {
...
static rosidl_message_type_support_t _JointsStates__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JointsStates__callbacks,
...
{
  return &pi3hat_moteus_int_msgs::msg::typesupport_fastrtps_cpp::_JointsStates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pi3hat_moteus_int_msgs, msg, JointsStates)() {
  return &pi3hat_moteus_int_msgs::msg::typesupport_fastrtps_cpp::_JointsStates__handle;
}
