...
#include "pi3hat_moteus_int_msgs/msg/detail/joints_command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // effort, kd_scale, kp_scale, position, velocity
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // effort, kd_scale, kp_scale, position, velocity
...
using _JointsCommand__ros_msg_type = pi3hat_moteus_int_msgs__msg__JointsCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointsCommand__ros_msg_type * ros_message = static_cast<const _JointsCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _JointsCommand__ros_msg_type * ros_message = static_cast<_JointsCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: kp_scale
  {
    ...
    if (ros_message->kp_scale.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->kp_scale);
    }
  ...
  // Field name: kd_scale
  {
    ...
    if (ros_message->kd_scale.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->kd_scale);
    }
...
static uint32_t _JointsCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pi3hat_moteus_int_msgs__msg__JointsCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pi3hat_moteus_int_msgs__msg__JointsCommand;
    is_plain =
      (
...
static size_t _JointsCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pi3hat_moteus_int_msgs__msg__JointsCommand(
...
static message_type_support_callbacks_t __callbacks_JointsCommand = {
...
static rosidl_message_type_support_t _JointsCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointsCommand,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pi3hat_moteus_int_msgs, msg, JointsCommand)() {
  return &_JointsCommand__type_support;
}
