...
static const _PacketPass_type_support_symbol_names_t _PacketPass_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pi3hat_moteus_int_msgs, msg, PacketPass)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pi3hat_moteus_int_msgs, msg, PacketPass)),
  }
};
...
{
  return &::pi3hat_moteus_int_msgs::msg::rosidl_typesupport_cpp::PacketPass_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pi3hat_moteus_int_msgs, msg, PacketPass)() {
  return get_message_type_support_handle<pi3hat_moteus_int_msgs::msg::PacketPass>();
}
